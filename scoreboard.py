...
class Scoreboard:
    ...
    def prep_ships(self):
        ...
        for ship_number in range(self.stats.ships_left):
            ...
            heart.image = pygame.image.load(r"C:\Users\ayush\OneDrive\Desktop\game project\alien_invasion\images\editted pink heart.png").convert()  # Make sure this file exists
            ...
            heart.rect.y = 10
            heart.image.set_colorkey((255,255,255))  # Optional: removes black background if needed
            heart.add(self.ships)
